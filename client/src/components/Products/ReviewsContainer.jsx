...
const ReviewsContainer = ({ product, productReviews }) => {
  ...
  const handleReviewSubmit = (e) => {
    ...
    dispatch(postReview({ id: product.id, review: data }));
  };
  return (
    <>
      {authUser && (
            ...
            {[...Array(5)].map((_, i) => {
              return (
                <button 
                  ...
                  className={`text-2xl ${i < rating ? "text-yellow-400" : "text-green-300"}`}
                >
                  ☆
                </button>
              )
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1">
                    ...
                    {authUser?.id === review.reviewer?.id && (
                      <button 
                        onClick={() => dispatch(deleteReview({ id: product.id, reviewId: review.review_id }))}
