...
import { getProductWithAI } from "../../store/slices/productSlice";
...
const AISearchModal = () => {
  ...
  const exampleText = [
    "Tìm card đồ họa phù hợp nhất với Ryzen 5600X",
    "Tìm tất cả áo khoác da nam",
    "Find all red t-shirts for me",
  ];
  const handleSearch = (e) => {
    e.preventDefault();
    dispatch(getProductWithAI(userPrompt));
  };
