              ...
              >
                ...
                <div className="relative overflow-hidden rounded-lg mb-4">
                  <img 
                    ...
                    alt={product.name} 
                    className="w-full h-48 object-contain group-hover:scale-110 transiton-transform duration-300"
                  />
                  {/* BADGES */}
                  <div className="absolute top-3 left-3 flex flex-col space-y-2">
                    ...
                    {product.ratings > 4.5 && (
                      <span className="px-2 py-1 bg-gradient-to-r from-yellow-400 to-rose-500 text-white 
                      bg-primary text-primary-foreground text-xs font-semibold rounded">TOP RATED</span>
                    )}
                  </div>
                  ...
                  <button 
                    ...
                    opacity-0 group-hover:opacity-100 transiton-opacity"
                ...
                <div>
                  ...
                  transition-colors">{product.name}</h3>
                  {/* PRODUCT RATINGS */}
